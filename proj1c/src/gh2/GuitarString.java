...
public class GuitarString {
    ...
    // TODO: uncomment the following line once you're ready to start this portion
     private LinkedListDeque61B<Double> buffer = new LinkedListDeque61B<>();
    ...
    public void pluck() {
        ...
        LinkedListDeque61B.Node temp = buffer.sentinel.back;
        while(temp.front.back != buffer.sentinel){
           temp.middle = Math.random() - 0.5;
           temp = temp.back;
        }
    }
    ...
    public void tic() {
        ...
        double num = (this.sample() + buffer.get(1)) / 2 * DECAY;
        buffer.addLast(num);
        buffer.removeFirst();
    }
