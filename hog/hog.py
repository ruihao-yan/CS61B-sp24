...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    a=[dice() for _ in range(num_rolls)]
    for i in a:
        if i ==1:
            return 1
    return sum(a)
...
def sus_points(score):
    ...
    if 3<=num_factors(score)<=4:
        for i in range(score,2*score+1):
            if is_prime(i):
                return i
    return score
    # END PROBLEM 4
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    return sus_points(player_score+roll_dice(num_rolls,dice))
    # END PROBLEM 4
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who ==0:
            ...
            score0=update(dice0,score0,score1,dice)
        else:
            dice1=strategy1(score1,score0)
            score1=update(dice1,score1,score0,dice)
        who=1-who
    # END PROBLEM 5
...
def make_averaged(original_function, samples_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    def fun(*args):
        roll_total,roll_nums=0,samples_count
        while roll_nums:
            roll_total+=original_function(*args)
            roll_nums-=1
        return roll_total/samples_count
    return fun
    # END PROBLEM 8
