...
public class PercolationTest {
    ...
    @Test
    public void yourFirstTestHere1() {
        int N = 3;
        Percolation p = new Percolation(N);
        int[][] openSites = {
                {0,0},
        ...
        Cell[][] expectedState = {
                ...
                {Cell.FULL, Cell.CLOSED, Cell.FULL},
        };
        assertThat(getState(N, p)).isEqualTo(expectedState);
    }
    @Test
    public void yourFirstTestHere2() {
        int N = 3;
        Percolation p = new Percolation(N);
        int[][] openSites = {
                {0,2},
        ...
        Cell[][] expectedState = {
                ...
                {Cell.OPEN, Cell.CLOSED, Cell.FULL},
                {Cell.OPEN, Cell.CLOSED, Cell.FULL},
        };
        assertThat(getState(N, p)).isEqualTo(expectedState);
    }
    ...
    @Test
    public void yourFirstTestHere3() {
        int N = 3;
        Percolation p = new Percolation(N);
        int[][] openSites = {
                {0,1},
