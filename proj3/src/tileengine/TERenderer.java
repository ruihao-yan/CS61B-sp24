...
public class TERenderer {
     ...
     */
    //创造整个世界框架,世界w的x,h的y.当渲染时不会在世界左边渲染xOff,右边渲染xOff + yOff,上边渲染yOff,下边渲染abs(yOff - xOff)
     ...
     * @param h height of the window in tiles.
     */
    //初始化整个世界,当渲染框架小于初始化的世界时,留下x(w - 渲染框架x值) 和 y 的空白
     ...
     */
    //渲染世界,可以使用xOff or yOff 来创造 empty space
